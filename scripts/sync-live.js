...
async function syncLive() {
    ...
    const halls = [
        ...
        { slug: "highrise-hall", name: "Highrise Hall", desc: "Intimate and professional setting for executive board meetings and private discussions.", image: "https://res.cloudinary.com/dizwm3mic/image/upload/v1772447101/parkside-villa-media/CONFERENCE_HALLS_Highrise/IMG_5868_f2be2r.jpg", capacity: 50, setups: ["Boardroom", "U-Shape"] },
        { slug: "masai-mara-hall", name: "Masai Mara Hall", desc: "Expansive and grand hall designed for major exhibitions, galas, and summits.", image: "https://res.cloudinary.com/dizwm3mic/image/upload/v1772446864/parkside-villa-media/CONFERENCE_HALLS_Masaai_Mara/IMG_5867_p2yis8.jpg", capacity: 300, setups: ["Theatre", "Banquet", "Reception"] },
        { slug: "longonot-hall", name: "Longonot Hall", desc: "State-of-the-art boardroom with panoramic views, perfect for high-level executive meetings.", image: "https://res.cloudinary.com/dizwm3mic/image/upload/v1772446820/parkside-villa-media/CONFERENCE_HALLS_Longonot/IMG_5903_vsc7o3.jpg", capacity: 30, setups: ["Boardroom"] },
    ];
