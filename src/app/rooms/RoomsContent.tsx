...
export default function RoomsContent({ initialRooms, content }: RoomsContentProps) {
    const router = useRouter();
    const { formatPrice } = useCurrency();
    const [rooms] = useState<any[]>(initialRooms);
    ...
    const [filteredRooms, setFilteredRooms] = useState<any[]>(initialRooms);
    ...
    return (
        <>
            ...
            {/* BOOKING MODAL (Moved from original page) */}
            <AnimatePresence>
