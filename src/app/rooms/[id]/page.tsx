...
import styles from "../[id]/room-detail.module.css";
...
export default function RoomDetail() {
    ...
    useEffect(() => {
        getSiteData().then(data => {
            const foundRoom = data.rooms.find((r: any) => r.id === params.id);
            if (foundRoom) {
                setRoom(foundRoom);
                // Track Recent Views
                const stored = localStorage.getItem("recentRooms") || "[]";
                const recent = JSON.parse(stored);
                const filtered = recent.filter((r: any) => r.id !== foundRoom.id);
                const updated = [foundRoom, ...filtered].slice(0, 4);
    ...
    if (loading) return <div className={styles.loading}>Loading Luxury...</div>;
    if (!room) return null;
        ...
        <div className={styles.pageWrapper}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.container}>
                    <Link href="/#accommodation" className={styles.backLink}>
                ...
                {isBookingModalOpen && (
                    ...
                    >
                        ...
                        >
                            ...
                            <p className={styles.modalSubtitle}>{room.price} / per night</p>
